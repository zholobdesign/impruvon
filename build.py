...
@media (max-width:760px){
  ...
  .navitem .sub{position:static;display:block;border:0;box-shadow:none;padding:0 0 0 12px;min-width:0}
  .navitem .sub a{padding:4px 0;font-size:13px;color:var(--mut)}
}
